...
class PersonResourceIT {
    ...
    private static final String DEFAULT_SGID = "AAAAAAAAAA";
    private static final String UPDATED_SGID = "BBBBBBBBBB";
    ...
    public static Person createEntity(EntityManager em) {
        Person person = new Person().sgid(DEFAULT_SGID);
        return person;
    }
    ...
    public static Person createUpdatedEntity(EntityManager em) {
        Person person = new Person().sgid(UPDATED_SGID);
        return person;
    }
    ...
    void createPerson() throws Exception {
        ...
        assertThat(testPerson.getSgid()).isEqualTo(DEFAULT_SGID);
    }
    ...
    void getAllPeople() throws Exception {
        ...
        restPersonMockMvc
            ...
            .andExpect(jsonPath("$.[*].sgid").value(hasItem(DEFAULT_SGID)));
    }
    ...
    void getPerson() throws Exception {
        ...
        restPersonMockMvc
            ...
            .andExpect(jsonPath("$.sgid").value(DEFAULT_SGID));
    }
    ...
    void putNewPerson() throws Exception {
        ...
        updatedPerson.sgid(UPDATED_SGID);
        ...
        Person testPerson = personList.get(personList.size() - 1);
        assertThat(testPerson.getSgid()).isEqualTo(UPDATED_SGID);
    }
    ...
    void fullUpdatePersonWithPatch() throws Exception {
        ...
        partialUpdatedPerson.sgid(UPDATED_SGID);
